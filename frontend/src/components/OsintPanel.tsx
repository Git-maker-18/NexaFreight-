...
import {
  ...
  Maximize2, Minimize2, Gavel, Phone, Terminal, ShieldAlert, User, Skull, Monitor, KeyRound
} from 'lucide-react';
  ...
  const runLookup = useCallback(async () => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        } else if (activeTab !== 'sweep' && activeTab !== 'vuln' && activeTab !== 'username' && activeTab !== 'mac' && activeTab !== 'bgp' && activeTab !== 'github' && activeTab !== 'leaks' && activeTab !== 'phone' && activeTab !== 'infostealer') {
